...
# StyleTime Algorithm
def style_time(content_series, style_series, iterations=2000, alpha=1. , beta=100.0, gamma=0.0001, learning_rate=0.01):
...
if __name__ == '__main__':
    ...
    style_data_path = "src/data/raw/simulated_dataset/output_noise/1.75.h5"
